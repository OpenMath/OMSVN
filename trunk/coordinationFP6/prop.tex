...
Dictionaries, by dissemination and training, setting up editorial
...
REDUCE, and AXIOM, special purpose systems such as GAP, CoCoA.
...
\item computationally relevant fields ranging from NIST digital
  ...
  or planar geometry (handled by Cinderella and Botana?). Special
