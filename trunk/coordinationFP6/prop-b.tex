...
\item[Johannes Kepler University Linz] \ednote{need something new
    here, was: RISC is one of the largest research centers for
    Computer Algebra in the world.  It played a substantial part in
    the development of the OpenMath~2 Standard and of the MONET
    protocols.}
  
\item[German Research Centre for Artificial Intelligence (DFKI)] Based
  at the DFKI, the ActiveMath project is developing technology for
