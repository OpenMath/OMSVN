...
{\texttt{calculus3}}\footnote{{\texttt{calculus2}} already exists as an experimental CD on
  {\texttt{openmath.org}}} that is more closely alingned with {\mathml2} representation
...
alingned with {\mathml2} representation intuitions as a replacement for the {\openmath}
